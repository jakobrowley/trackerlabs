...
void PackOpenCL(int keyID, char* infile, char* outfile);
void UnPackCLContent(int keyID, char* pData, int nSize);

void EncryptLicense(unsigned short crc, char* in, char* encrypted_license);
void DecryptLicense(unsigned short crc, char* encrypted_license, char* license);
